...
void canvas_blur_gaussian(uint32_t* destination, int size, int width, int height, uint32_t blur_level = 4096);
void canvas_blur_box(uint32_t* destination, int size, int width, int height, uint32_t blur_level = 3);
